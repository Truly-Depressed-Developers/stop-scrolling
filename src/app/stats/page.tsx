    ...
    return (
        <div>
            <Header className="flex justify-center">
                <h1 className="text-xl">Dzisiaj spędziłeś na telefonie</h1>
            </Header>
            ...
            <div className="m-4 flex flex-col space-y-4 rounded-3xl bg-secondary p-4">
                {data
                    .toSorted((a, b) => b.minutes - a.minutes)
                    .map((el, _) => (
                        <div key={el.name}>
                            <h2>
                                {el.name} - {Math.floor(el.minutes / 60)}h{" "}
                                {el.minutes % 60}min
                            </h2>
                            <Progress
