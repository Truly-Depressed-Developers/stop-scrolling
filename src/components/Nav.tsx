...
const Nav = () => {
    ...
    return (
        <div className="w-full">
            <div className="mx-auto mb-1 flex w-11/12 justify-evenly rounded-lg border py-2 shadow-md">
                <Link href={"/streak"}>
                    <svg
                        width="48"
                        height="48"
                    ...
                    >
                        <path
                            ...
                            stroke={pathname === "/streak" ? color : "#000"}
                            stroke-width="2"
                ...
                <Link href={"/stats"}>
                    ...
                    >
                        <path
                            ...
                            stroke={pathname === "/stats" ? color : "#000"}
                            stroke-width="2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
                ...
                <Link href={"/chat"}>
                    ...
                    >
                        <path
                            ...
                            stroke={pathname === "/chat" ? color : "#000"}
                            stroke-width="2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
                ...
                <Link href={"/history"}>
                    ...
                    >
                        <path
                            d="M3 3V8H8"
                            stroke={pathname === "/history" ? color : "#000"}
                            stroke-width="2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
